...
| **Text Encoding** | UTF-16, ISO-8859-1 | **CRITICAL:** The device UI runs natively on UTF-16. There is **no UTF-8 decoder** in the firmware. UTF-8 encoded tags will render as corrupted garbage text on the screen. Convert rewrites ID3 UTF-8 frames to UTF-16 (ID3v2.3) without re-encoding audio. |
